...
public class Notification123 extends javax.swing.JComponent {
    ...
    public Notification123(Frame fram, Type type, Location location, String message) {
        this.fram = fram;
        this.type = type;
...
//                        y = fram.getY() + ((fram.getHeight() - dialog.getHeight()) / 2);
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/sucess.png"))); // NOI18N
    ...
    public static enum Location {
        TOP_CENTER, TOP_RIGHT, TOP_LEFT, BOTTOM_CENTER, BOTTOM_RIGHT, BOTTOM_LEFT, CENTER , LEFT_CENTER ;
    }
