...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        add(title);
        description = new JLabel("Để giữ kết nối với chúng tôi");
        description.setForeground(new Color(245, 245, 245));
        add(description);
        description1 = new JLabel("xin vui lòng nhập thông tin cá nhân của bạn");
    ...
    private void login(boolean login) {
        description.setFont(new java.awt.Font("Calibri ", 0, 14));
        description1.setFont(new java.awt.Font("Calibri ", 0, 14));
        button.setFont(new java.awt.Font("Calibri ", 0, 14));
        buttonExit.setFont(new java.awt.Font("Calibri ", 0, 14));
        if (this.isLogin != login) {
            if (login) {
                ...
                description.setText("Để giữ kết nối với chúng tôi");
                description1.setText("xin vui lòng nhập thông tin cá nhân của bạn");
